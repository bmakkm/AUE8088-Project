...
from utils.loss_base import ComputeLoss
...
def train(hyp, opt, device, callbacks):
    ...
    # # Check anchors if noautoanchor is False
    # if not opt.noautoanchor:
    #     LOGGER.info("Running autoanchor optimization...")
    #     check_anchors(dataset, model=model, thr=hyp['anchor_t'], imgsz=imgsz)
    #     LOGGER.info("Autoanchor optimization completed.")
